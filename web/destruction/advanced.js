...
const RECEIPT_TOPICS = [
  ...
  },
  {
    ...
    plainEnglish: 'Proves the destruction attestation came from real AMD silicon. We validate the certificate chain from the CPU up to AMD root keys, and confirm the hardware report was signed by that CPU.',
  },
  {
    id: 'key_binding',
    checkId: 'key_binding',
    ...
    plainEnglish: 'Confirms the signing key was bound into the hardware attestation for this destruction. The report must include a fingerprint of the public key combined with the session nonce.',
  },
  {
    id: 'attestation_hash',

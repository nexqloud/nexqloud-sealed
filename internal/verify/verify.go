...
func Verify(rc AttestationReceipt, pub ed25519.PublicKey, pins Pins, roots HardwareRoots) Result {
	...
	return VerifyKeyBinding(rc, pub, pins)
}

func VerifyKeyBinding(rc AttestationReceipt, pub ed25519.PublicKey, pins Pins) Result {
	if rc.Attestation == nil || rc.Attestation.Report == nil {
		return fail("missing-attestation")
	}
